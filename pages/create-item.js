    ...
    <div className="flex justify-center">
      <div className="w-1/2 flex flex-col pb-12">
        <input
          ...
          onChange={e => updateFromInput({ ...fromInput, name: e.target.value })}
        />
        <textarea
          placeholder="Asset Description"
          className="mt-2 border rounded p-4"
          onChange={e => updateFromInput({ ...fromInput, description: e.target.value })}
        />
        <input
          placeholder="Asset Price in Matic"
          className="mt-2 border rounded p-4"
          onChange={e => updateFromInput({ ...fromInput, price: e.target.value })}
        />
        <input
          type="file"
          name="Asset"
